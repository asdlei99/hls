#define NGX_CONFIGURE " --with-http_ssl_module --add-module=../nginx-vod-module-master --add-module=../nginx-secure-token-module-master --add-module=../nginx-akamai-token-validate-module-master"
